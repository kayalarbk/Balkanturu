...
| | |
|---|---|
| Havayolu / sefer | AJet **VF101** |
| PNR | **4FQPAT** |
| Kalkış | 09:50 — İstanbul Sabiha Gökçen (SAW) |
| İniş | 10:30 — Priştine (PRN) |
| Süre | 1 sa 40 dk |
| Bagaj | Kabin 40 × 15 × 30 cm / 4 kg + 10 kg ek bagaj |

### Dönüş — 20 Ağustos 2026, Perşembe
| | |
|---|---|
| Havayolu / sefer | Pegasus **PC284** |
| PNR | **29BHAE** |
| Kalkış | 02:15 — Tiran Nene Tereza (TIA) |
| İniş | 04:50 — İstanbul Sabiha Gökçen (SAW) |
| Süre | 2 sa 35 dk |
| Bagaj | 20 kg valiz + 8 kg kabin |

> ⚠️ **GECE UÇUŞU.** Bu uçuş 19 Ağustos'u 20'ye bağlayan gece kalkıyor. 19 Ağustos Çarşamba
> akşamı havalimanında olunacak, ~23:30'da merkezden hareket edilecek. **19 Ağustos gecesi
> konaklama yok.**
...
- **Su & sağlık:** musluk suyu içilebilirliği yere göre değişiyor, pratikte şişe su.
  Acil numara **112** (üç ülkede de). Seyahat sağlık sigortası _alınacak_.
- **Bahşiş:** restoranda ~%10 veya yukarı yuvarlama; kafede bozuk para yeterli.
  Dini mekânlarda omuz/diz kapalı.
- **Kelimeler:** Makedonca _zdravo_ / _blagodaram_ / _kolku çini?_ ·
  Arnavutça _Përshëndetje_ / _Faleminderit_ / _Sa kushton?_
...
- [ ] 🚌 Otobüs biletleri (Priştine-Üsküp, Üsküp-Ohrid, Ohrid-Dıraç)
- [ ] 🏨 Konaklama rezervasyonları (Üsküp 1, Ohrid 3, Dıraç 3 gece)
- [ ] 💱 Euro / denar / lek bozdurma
- [ ] 🗺 Offline harita indir (üç ülke)
- [ ] 🔌 Şarj aleti, powerbank, adaptör
- [ ] 🧴 Güneş kremi ve mayo
- [ ] 🏖 Dıraç için plaj çantası
- [ ] ⏰ Gece uçuşu için alarm ve havalimanı transferi
...
- Kesin uçuş bilgileri eklendi: gidiş AJet VF101 (PNR 4FQPAT), dönüş Pegasus PC284
  (PNR 29BHAE); saatler, havalimanları ve bagaj hakları bilet üzerinden girildi.
- Dönüş uçuşunun **gece kalkışı** (19 Ağustos akşamı havalimanı, 02:15 kalkış) hem uçuş
  kartında hem 19-20 Ağustos günlerinde belirgin uyarı olarak işlendi.
- Konaklama kesinleştirildi: Üsküp 1, Ohrid 3, Dıraç 3 gece; 19 Ağustos gecesi konaklama yok.
- `index.html` sıfırdan yazıldı: tek dosya, harici bağımlılık yok, tüm içerik dosya başındaki
  `TUR` objesinde; hero + canlı geri sayım, uçuş kartları, rota şeridi, şehir kartları,
  9 günlük accordion program (bugün otomatik vurgulanır), ulaşım tablosu, pratik bilgi
  bölümü ve localStorage'lı hazırlık listesi.
- Tasarım Adriyatik temasına geçirildi (derin mavi/turkuaz + kum beji), CSS token'ları
  `:root` altında toplandı, bölümler HTML yorumlarıyla ayrıldı.
- Rehber ağzından şehir tanıtım paragrafları ve her güne "En iyi saat / Dikkat / İpucu"
  notları yazıldı.
- Eski `TUR-PLANI.md` kaldırıldı, yerine tek doğruluk kaynağı olarak bu `PLAN.md` geldi.
- Repo düzeni kuruldu: `README.md`, `.gitignore`, `docs/`.
